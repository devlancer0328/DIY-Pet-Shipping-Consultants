...
export default function Considers() {
    return (
        <section id="considers" className="dark:text-black flex justify-center pt-5 pb-10 w-full scroll-mt-24 bg-[#E5E7F0] rounded-bl-[40px] md:rounded-bl-[150px] items-center">
            <div className="max-w-7xl w-full px-4 md:px-12 flex flex-col lg:flex-row flex-wrap items-center text-center gap-8">
                <div className="text-center pt-8 items-center w-full">
